class Movement < ApplicationRecord
    ...
    def create_inverse
        self.class.create(inverse_movement_options)
    end
    ...
    def has_inverse?
        self.class.exists?(inverse_movement_options)
    end

    def inverses
        self.class.where(inverse_movement_options)
    end

    def inverse_movement_options
